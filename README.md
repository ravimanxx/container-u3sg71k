...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u3sg71k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u3sg71k.containers.anotherwebservice.com/
...
```
git clone git@github.com:ravimanxx/container-u3sg71k.git
cd container-u3sg71k
```
...
```
docker attach container-u3sg71k
```
